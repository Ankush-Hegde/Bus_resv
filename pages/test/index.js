                                ...
                                seats.map((seat) => {
                                    return (
                                        <tr>
                                            ...
                                            <td>{seat.dep_time}</td>
                                            {/* <td>{seat.price}</td> */}
                                            <td className={styles.button} ><a href="/test/seets">Reserve </a></td>
                                        </tr>
                                    );
                                })
                            }
                            <tr >
                                <th><a href='/test/booking'>booking</a></th>
                                <th><a href='/test/test'>test</a></th>
                                <th><a href='/test/seets'>seets</a></th>
                                <th><a href='/test/index1'>index1</a></th>
                                {/*<th>Date</th>*/}
                                <th><a href='/test/cancle'>cancle</a></th>
                                {/* <th>Availability</th> <th>price</th>*/}
                                <th><a href='/test/test2'>test2</a></th>
                            </tr>
                        </tbody>
                    </table>
                </div>
