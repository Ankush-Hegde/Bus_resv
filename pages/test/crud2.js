...
export default function Home() {
    ...
    async function getProduct() {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_URL}/api/crud`,
        postData
        );
    ...
    async function addProduct() {
        ...
        const res = await fetch(
            `${process.env.NEXT_PUBLIC_URL}/api/crud`,
        postData
        );
        console.log(res)
        const response = await res.json();
    ...
    async function deleteProduct(id) { 
        ...
        const productTORemove = parseFloat(response.response.id);
        setProducts(products.filter((a) => a.id !== productTORemove));
