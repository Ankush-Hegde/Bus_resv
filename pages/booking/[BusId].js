...
export default function Home() {
    ...
    var arraySeats = [];
    //var arrayOptions = ['1A','2A','3A','4A','5A','6A','7A','1B','2B','3B','4B','5B','6B','7B','1C','2C','3C','4C','5C','6C','7C','1D','2D','3D','4D','5D','6D','7D','1E','2E','3E','4E','5E','6E','7E','7F'];
    const seatNameRef = useRef();
    const [created, setCreated] = useState(false);

    const router = useRouter();
    const BusIId = router.query.BusId;

    //console.log(BusIId)

    async function addSeat(BusIId) {
        ...
        const res = await fetch(
            `${process.env.NEXT_PUBLIC_URL}/api/BusId/booking`,
            postData
        );
        console.log(res)
    ...
    async function getSeats(BusIId) {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_URL}/api/BusId/${BusIId}`,
    ...
    //     for(var j=0;j<=arraySeats;j++){
    //         if(arrayOptions[i]==arraySeats[j]){
    //             arrayOptions.pop(i);
    //         }
    //         else{continue}
    //     }
        ...
        <div>
            <div className={styles.main}>
                ...
                <div>
                    ...
                    <button className={styles.Paybutton} onClick={function(event){addSeat(BusIId);getValue();}}>BOOK SEAT</button>
